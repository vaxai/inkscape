...
set(PERF_TEST_MAX_TIME "15" CACHE STRING
    "Maximum wall-clock time in seconds allowed for a performance test before it fails")
...
#
# NOTE: This retrieves the COMMAND property from the existing test, which
# requires CMake 3.24+ (already the project minimum).
# -----------------------------------------------------------------------------
function(add_performance_test_for_existing existing_test_name)
    ...
    if(NOT TEST ${existing_test_name})
        message(WARNING
            "add_performance_test_for_existing: test '${existing_test_name}' does not exist; skipping")
        return()
    endif()
    ...
    if(NOT _cmd)
        message(WARNING
            "add_performance_test_for_existing: test '${existing_test_name}' has no COMMAND; skipping")
        return()
    endif()
