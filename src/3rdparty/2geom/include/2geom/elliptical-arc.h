...
public:
    ...
    /**
     * Build an EllipticalArc passing through the origin of the specified initial tangent line,
     * then through the specified point, and terminating at the origin of the specified final tangent line.
     *
     * @param initial_tangent  A line which the arc should be tangent to at its initial point.
     * @param point_on_arc     A point which the arc should pass through.
     * @param final_tangent    A line which the arc should be tangent to at its final point.
     *
     * @return An arc from initial_tangent.origin() to final_tangent.origin() passing through point_on_arc.
     * @throws RangeError exception if no such arc can be found.
     */
    static EllipticalArc from_tangents_and_point(Line const &initial_tangent, Point const &point_on_arc,
