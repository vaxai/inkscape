...
TEST(EllipseTest, PointAndDerivatives)
{
    auto const ellipse = Ellipse{Point{3, 2}, {4, 5}, M_PI / 7};
    ...
    auto const taylor_series = ellipse.pointAndDerivatives(ta, N);
    ...
    EXPECT_near(pt, ellipse.pointAt(tb), 1e-10);
}
