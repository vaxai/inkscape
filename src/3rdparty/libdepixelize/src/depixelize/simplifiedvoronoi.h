...
#ifndef LIBDEPIXELIZE_SIMPLIFIEDVORONOI_H
#define LIBDEPIXELIZE_SIMPLIFIEDVORONOI_H
...
public:
    ...
    using reverse_iterator = typename std::vector<Cell>::reverse_iterator;

    using const_reverse_iterator = typename std::vector<Cell>::const_reverse_iterator;
...
private:
    ...
    using PointTransform = void (*)(Point<T> &p, T dx, T dy);
    using NodeTransform = bool (*)(PixelGraph::const_iterator);
...
#endif // LIBDEPIXELIZE_SIMPLIFIEDVORONOI_H
